...
public class LegendarySwords {
    ...
    public static void registerSwords(CustomWeaponEngine plugin) {
        ...
        // 11. Excalibur
        ItemStack excalibur = createSword(plugin, "cwe_excalibur", "Excalibur", "MYTHIC",
                500, 250, 30, 120, 0, 0, 150, 15,
                "Holy Light", "Ánh Sáng Thánh: Triệu hồi sấm sét", "gây 5000 sát thương diện rộng. Cooldown: 30s", "RIGHT CLICK");
        lib.set("items.cwe_excalibur", excalibur);
    ...
    public static ItemStack createSword(CustomWeaponEngine plugin, String id, String name, String rarity,
        ...
        if (id.equals("cwe_excalibur")) {
            item.setType(Material.NETHERITE_SWORD);
        } else if (id.equals("cwe_aotd") || id.equals("cwe_giants_sword") || id.equals("cwe_hyperion")) {
        ...
        if (meta != null) {
            String color = rarity.equals("MYTHIC") ? "§d" : (rarity.equals("LEGENDARY") ? "§6" : rarity.equals("EPIC") ? "§5" : "§9");
